<div class="caldera-url-builder-main-headercaldera">
		...
		<button type="submit" class="add-new-h2 wp-baldrick" data-action="cub_rebuild_rules" data-active-class="none" data-load-element="#caldera-url-builder-save-indicator"><?php _e('Rebuild Rewrites', 'caldera-url-builder') ; ?></button>
